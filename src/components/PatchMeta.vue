...
const defaultMetas = {
  siteName: 'Dimitris Blog',
  title: 'Keep up to date with the latest news',
  description: 'I need a life',
  previewUrl: 'https://synux.net/logo.png',
  shareUrl: 'https://blog.dimitrishepherd.com/#/'
}
